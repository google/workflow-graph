...
export class DirectedAcyclicGraph implements AfterViewInit, OnInit, OnDestroy {
  ...
  constructor(
    ...
    this.focusElement = debounce(this.focusElement, 50);
    this.onVisualUpdate = debounce(this.onVisualUpdate, 50);
    this.handleResizeAsync = debounce(this.handleResizeAsync, 50);
    this.resetAnimationMode = debounce(this.resetAnimationMode, 1200);
