  ...
  describe('UI', () => {
    ...
    describe('with custom groups', () => {
      ...
      function setup(
        ...
        fixture = TestBed.createComponent(TestComponent);
        const skeleton =
            createDagSkeletonWithCustomGroups(hideControlNodeOnExpand, expanded)
        const graphSpec =
      ...
      it('renders correctly with group expanded', async () => {
        setup({hideControlNodeOnExpand: false, expanded: true});
        await screenShot.expectMatch(`graph_expanded_with_custom_control`);
      });

      it('renders correctly with group expanded and control hidden',
         async () => {
           setup({hideControlNodeOnExpand: true, expanded: true});
